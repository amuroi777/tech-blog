    ...
    <Flex height="100vh" alignItems="center" justifyContent="center">
      <Flex direction="column" rounded={6} padding={[6, 0, 0, 12]} w={["90%", "80%", "60%", "40%"]}>
        ...
        <form method="post" onSubmit={handleSubmit}>
          <Input name="email" type="email" placeholder="Enter your email" variant="filled" mb={5} rounded={13} borderColor="black.100" background="gray.200" width={{ base: "100%", sm: "100%", md: "100%", lg: "100%" }} />

          <Text mb={3} fontSize={["sm", "md", "lg", "xl"]}>
            Password
          </Text>
          <Input name="password" type="password" placeholder="Enter your password" variant="filled" mb={0} rounded={13} borderColor="black.100" background="gray.200" width={{ base: "100%", sm: "100%", md: "100%", lg: "100%" }} />
          ...
          <Text textAlign="center" fontWeight="bold">
            ...
            <Box as="span" color="blue.300" fontSize={{ base: "sm", sm: "md", md: "lg", lg: "xl" }} cursor="pointer" onClick={handleSignupClick}>
              Sign Up
            </Box>
          </Text>
        </form>
