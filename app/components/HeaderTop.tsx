    ...
    <Box bg="gray.300" px={4}>
      <Flex h={20} alignItems="center" pl="20px" justifyContent="space-between">
        ...
        <HStack spacing={8} alignItems="center">
          ...
          <Button mb={12} rounded="60px" padding="5px" mt="50px" bg="blackAlpha.800" width={{ base: "60%", sm: "60%", md: "60%", lg: "40%" }} fontSize={{ base: "md", md: "md", lg: "md" }} color={{ base: "#fff", sm: "#000" }} display={{ base: "block", md: "none" }}>
            <Link px={2} py={1} rounded="md" _hover={{ textDecoration: "none" }} href="#">
              <EditIcon mr={2} />
              Create
            </Link>
